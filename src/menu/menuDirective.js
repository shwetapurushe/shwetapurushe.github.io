...
myapp.directive('fancyMenu', function(){
        ...
        return {
            ...
            link : function(scope){
                ...
                var aboutC = {"r": 20 , "R": 180, color : '#00CCFF' , speed: 2, phi0: 400, path : '/about', text : "About Me"};
                var projectsC = {"r": 20 ,"R": 60, color: '#FF7C66',  speed: 2, phi0: 200, path : '/projects', text:"Projects"};
                var skillsC= {"r": 20 , "R": 120,color: '#705891', speed: 2,phi0: 100, path : '/skills', text: "Skills"};
